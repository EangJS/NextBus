    ...
    return (
        <main className={styles.main} style={{ gap: '20px' }}>
            ...
            <div className="bg-[#212529] rounded-2xl p-5 ml-10 mr-10 flex flex-wrap justify-center gap-5">
                ...
                <div className="bg-[#243240] hidden rounded-2xl p-5 flex-col justify-between">
            ...
            <footer>
                <div>
                    <a href="https://github.com/EangJS/NextBus" className="flex items-center gap-3 text-blue-500">
                        <p>Find the repository here</p>
                        <img height="30px" width="30px" src="/github-mark.svg" />
                    </a>
                </div>
